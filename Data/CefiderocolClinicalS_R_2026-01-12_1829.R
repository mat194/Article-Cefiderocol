...
Hmisc::label(data$record_id) = "Record ID"
Hmisc::label(data$questionnaire_timestamp) = "Survey Timestamp"
Hmisc::label(data$working_group) = "Would you like to be part of the CLEARER working group related publication?"
Hmisc::label(data$country) = "Where do you currently live or work?(Choose Rather not say if needed)"
Hmisc::label(data$city) = "City"
Hmisc::label(data$specialization) = "Please indicate your field of specialization"
Hmisc::label(data$specialization_other) = "If other, please specify"
Hmisc::label(data$mainrole) = "Are you a prescriber? "
Hmisc::label(data$experience) = "Please indicate the years of activity you have been involved in Infectious Diseases or related fields"
Hmisc::label(data$teach_hosp) = "Do you work at a university/teaching hospital?"
Hmisc::label(data$number_beds) = "Please indicate the number of beds in your hospital"
Hmisc::label(data$surveill_cr) = "Does your institution collect surveillance data on the prevalence of carbapenem-resistant pathogens?"
Hmisc::label(data$frequency_preval) = "Please specify how often prevalence/point prevalence investigations are performed at your hospital"
Hmisc::label(data$cre_k_prev) = "Please specify the approximate number of carbapenem-resistant Klebsiella pneumoniae isolates at your hospital over 100 K. pneumoniae positive blood cultures."
Hmisc::label(data$cre_p_prev) = "Please specify the approximate number of carbapenem-resistant Pseudomonas aeruginosa spp. isolates at your hospital over 100 P. aeruginosa positive blood cultures."
Hmisc::label(data$cre_a_pre) = "Please specify the approximate number of carbapenem-resistant Acinetobacter baumannii isolates at your hospital over 100 A. baumannii positive blood cultures."
Hmisc::label(data$cre_mechanism) = "Please indicate which is the most frequent resistance mechanism in carbapenem-resistant Enterobacterales"
Hmisc::label(data$spec_metal) = "Please specify"
Hmisc::label(data$spec_othermech) = "Please specify"
Hmisc::label(data$guidelines) = "Are there clinical guidelines for treating carbapenem-resistant pathogens at your disposal?"
Hmisc::label(data$available_guidelines___1) = "Please specify the type of available guidelines (choice=Hospital/institution)"
Hmisc::label(data$available_guidelines___2) = "Please specify the type of available guidelines (choice=Local)"
Hmisc::label(data$available_guidelines___3) = "Please specify the type of available guidelines (choice=National)"
Hmisc::label(data$available_guidelines___4) = "Please specify the type of available guidelines (choice=International)"
Hmisc::label(data$access_guidelines___1) = "What kind of platform grants you access to those guidelines? (choice=Hospital link)"
Hmisc::label(data$access_guidelines___2) = "What kind of platform grants you access to those guidelines? (choice=Online)"
Hmisc::label(data$access_guidelines___3) = "What kind of platform grants you access to those guidelines? (choice=Smartphone/tablet app)"
Hmisc::label(data$access_guidelines___4) = "What kind of platform grants you access to those guidelines? (choice=Paper based)"
Hmisc::label(data$algorithms) = "Do you have clinical algorithms to guide empirical antibiotic therapy for carbapenem-resistant pathogens  based on local epidemiological data?"
Hmisc::label(data$access_algorithms___1) = "How do you access those algorithms? (choice=Hospital link)"
Hmisc::label(data$access_algorithms___2) = "How do you access those algorithms? (choice=Online)"
Hmisc::label(data$access_algorithms___3) = "How do you access those algorithms? (choice=Smartphone/tablet app)"
Hmisc::label(data$access_algorithms___4) = "How do you access those algorithms? (choice=Paper based)"
Hmisc::label(data$stewardship) = "Is there an antimicrobial stewardship team supporting your work?"
Hmisc::label(data$acces_stewards___1) = "What platform grants you access to stewardship programs? (choice=Hospital link)"
Hmisc::label(data$acces_stewards___2) = "What platform grants you access to stewardship programs? (choice=Online)"
Hmisc::label(data$acces_stewards___3) = "What platform grants you access to stewardship programs? (choice=Smartphone/tablet app)"
Hmisc::label(data$acces_stewards___4) = "What platform grants you access to stewardship programs? (choice=Paper based)"
Hmisc::label(data$access_stewards___1) = "Please specify how you access to these platforms (choice=Available without restrictions (open access))"
Hmisc::label(data$access_stewards___2) = "Please specify how you access to these platforms (choice=Available only if you have special permission (private))"
Hmisc::label(data$access_stewards___3) = "Please specify how you access to these platforms (choice=Available with a subscription)"
Hmisc::label(data$carabap_detection) = "Is information regarding resistance mechanisms for suspected carbapenem-resistant bacteria available at your institution?"
Hmisc::label(data$kindoftestcr___1) = "Which kind of tests are available? (choice=Immunochromatography tests)"
Hmisc::label(data$kindoftestcr___2) = "Which kind of tests are available? (choice=Phenotypic methods)"
Hmisc::label(data$kindoftestcr___3) = "Which kind of tests are available? (choice=Molecular methods (PCR))"
Hmisc::label(data$kindoftestcr___4) = "Which kind of tests are available? (choice=I dont have this information)"
Hmisc::label(data$suscept_testcefi) = "Is cefiderocol susceptibility routinely tested at your hospital?"
Hmisc::label(data$casescefi_tested___1) = "When is cefiderocol tested? (choice=Every time a gram negative is isolated)"
Hmisc::label(data$casescefi_tested___2) = "When is cefiderocol tested? (choice=Every time a carbapenemase is detected)"
Hmisc::label(data$casescefi_tested___3) = "When is cefiderocol tested? (choice=Only if a metallo-betalactamase is detected (e.g., VIM, NDM, IMP))"
Hmisc::label(data$casescefi_tested___4) = "When is cefiderocol tested? (choice=Only when a gram negative isolate is resistant to other last-generation antibiotics)"
Hmisc::label(data$casescefi_tested___5) = "When is cefiderocol tested? (choice=If requested by the clinician)"
Hmisc::label(data$casescefi_tested___6) = "When is cefiderocol tested? (choice=I dont have this information)"
Hmisc::label(data$type_test___1) = "What cefiderocol susceptibility test is available at your institution? (choice=Broth microdiluition)"
Hmisc::label(data$type_test___2) = "What cefiderocol susceptibility test is available at your institution? (choice=Disk diffusion)"
Hmisc::label(data$type_test___3) = "What cefiderocol susceptibility test is available at your institution? (choice=Gradient strips (only for P. aeruginosa))"
Hmisc::label(data$type_test___4) = "What cefiderocol susceptibility test is available at your institution? (choice=Agar diffusion)"
Hmisc::label(data$type_test___5) = "What cefiderocol susceptibility test is available at your institution? (choice=Other)"
Hmisc::label(data$specify_senstest) = "Please specify other sensitivity test(s)"
Hmisc::label(data$brothmicrodil_specify) = "Please specify which kind  broth diluition method you use"
Hmisc::label(data$avail_cefid) = "Is cefiderocol available at your hospital?"
Hmisc::label(data$compass) = "Do you know if cefiderocol was prescribed for compassionate use at your hospital?"
Hmisc::label(data$rct_cefid) = "Do you know if cefiderocol has been used in randomized clinical trials at your hospital?"
Hmisc::label(data$clprac_cef) = "Is cefiderocol used in clinical practice at your hospital?"
Hmisc::label(data$pharmacy_restrict) = "Is cefiderocol use restricted by your hospitals pharmacy (e.g. allowed only with specialist prescription)?"
Hmisc::label(data$icu_only) = "Is cefiderocol use limited to the intensive care unit at your hospital?"
Hmisc::label(data$n_treatments) = "Please specify how often you believe cefiderocol is prescribed in a month at your hospital? "
Hmisc::label(data$cefi_cre_nonspecified) = "Would you normally use cefiderocol for carbapenem-resistant Enterobacterales (CRE) before the mechanism of resistance is known?"
Hmisc::label(data$combocreempiric) = "Would you use it alone or in combination?"
Hmisc::label(data$cefi_crenonndm) = "Would you normally use cefiderocol for CRE that do not produce metallo-betalactamases?"
Hmisc::label(data$combocreempiric_2) = "Would you use it alone or in combination?"
Hmisc::label(data$cefi_crendm) = "Would you use cefiderocol for CRE producing metallo-betalactamases?"
Hmisc::label(data$cefi_crpa) = "Would you normally use cefiderocol as a treatment option for carbapenem-resistant P. aeruginosa (CRPA)?"
Hmisc::label(data$cefi_crpandm) = "Would you use cefiderocol for CRPA producing metallo-betalactamases?"
Hmisc::label(data$cefi_crab) = "Would you normally use cefiderocol as an option for carbapenem-resistant Acinetobacter baumannii (CRAB)?"
Hmisc::label(data$cefi_crab_combo) = "Would you use it alone or in combination?"
Hmisc::label(data$cuti) = "Complicated UTI"
Hmisc::label(data$bsi) = "BSI"
Hmisc::label(data$hap_vap) = "HAP/VAP"
Hmisc::label(data$cnsi) = "CNS infection"
Hmisc::label(data$cai) = "Complicated abdominal infection"
Hmisc::label(data$off_l) = "Other type of infection (e.g., bone or skin/soft tissues)"
Hmisc::label(data$percept_crab_n_m) = "CRAB (non metallo-betalactamase)"
Hmisc::label(data$percept_crab_mb) = "CRAB (metallo-betalactamase)"
Hmisc::label(data$percept_crpa_n_mb) = "CRPA (non metallo-betalactamase)"
Hmisc::label(data$percptcrpa_mb) = "CRPA (metallo-betalactamase)"
Hmisc::label(data$perceptcre_n_mb) = "CRE (non metallo-betalactamase)"
Hmisc::label(data$perceptcre_mb) = "CRE (metallo-betalcactamase)"
Hmisc::label(data$percept_cuti) = "Complicated UTI"
Hmisc::label(data$percept_bsi) = "BSI"
Hmisc::label(data$percept_hap_vap) = "HAP/VAP"
Hmisc::label(data$percept_cns) = "CNS infection"
Hmisc::label(data$percept_cai) = "Complicated abdominal infection"
Hmisc::label(data$compar_colistin) = "Colistin/Polymyxin B"
Hmisc::label(data$compar_meropenem) = "Meropenem"
Hmisc::label(data$compar_c_avi) = "Ceftazidime/avibactam"
Hmisc::label(data$compar_c_tazo) = "Ceftolozane/tazobactam"
Hmisc::label(data$compar_fosfo) = "Fosfomycin"
Hmisc::label(data$compar_amika) = "Amikacin"
Hmisc::label(data$compar_plazo) = "Plazomicin"
Hmisc::label(data$compar_tige) = "Tigecyclin"
Hmisc::label(data$compar_mer_vabo) = "Meropenem/vaborbatam"
Hmisc::label(data$copar_imi_rele) = "Imipenem/relebactam"
Hmisc::label(data$capmpar_c_avi_aztr) = "Ceftazidime/avibactam+aztreonam"
Hmisc::label(data$non_cr) = "Do you use cefiderocol for carbapenem-susceptible isolates?"
Hmisc::label(data$cases_noncr) = "In which cases?"
Hmisc::label(data$combination) = "Do you use cefiderocol in combination with other anti gram-negative antibiotics?"
Hmisc::label(data$drugs_combination___1) = "Please list your preferred antibiotic(s) to use in combination with cefiderocol (choice=Aminoglycosides)"
Hmisc::label(data$drugs_combination___2) = "Please list your preferred antibiotic(s) to use in combination with cefiderocol (choice=Carbapenems)"
Hmisc::label(data$drugs_combination___3) = "Please list your preferred antibiotic(s) to use in combination with cefiderocol (choice=Colistin/polymyxin B)"
Hmisc::label(data$drugs_combination___4) = "Please list your preferred antibiotic(s) to use in combination with cefiderocol (choice=Tetracyclines)"
Hmisc::label(data$drugs_combination___5) = "Please list your preferred antibiotic(s) to use in combination with cefiderocol (choice=Ampicillin/sulbactam)"
Hmisc::label(data$drugs_combination___6) = "Please list your preferred antibiotic(s) to use in combination with cefiderocol (choice=Quinolones)"
Hmisc::label(data$drugs_combination___7) = "Please list your preferred antibiotic(s) to use in combination with cefiderocol (choice=Fosfomycin)"
Hmisc::label(data$drugs_combination___8) = "Please list your preferred antibiotic(s) to use in combination with cefiderocol (choice=Other (specify))"
Hmisc::label(data$specfy_combo) = "Please specify"
Hmisc::label(data$reason_combo___1) = "What is the main reason for combination therapy (choice=To decrease the selection of antibiotic resistant bacteria)"
Hmisc::label(data$reason_combo___2) = "What is the main reason for combination therapy (choice=In case of sepsis or septic shock)"
Hmisc::label(data$reason_combo___3) = "What is the main reason for combination therapy (choice=In immunocompromised patients)"
Hmisc::label(data$reason_combo___4) = "What is the main reason for combination therapy (choice=According to the isolates)"
Hmisc::label(data$specify_isolatecombo) = "Please specify for which isolate(s) do you use cefiderocol in combination "
Hmisc::label(data$var_dose) = "Do you usually use cefiderocol according to the Hmisc::label dosage of 2 g every 8 hours (with changes according to renal function) or also at different doses? "
Hmisc::label(data$var_dose_why___1) = "Why? (choice=Based on local therapeutic drug monitoring)"
Hmisc::label(data$var_dose_why___2) = "Why? (choice=I increase the dose for sepsis/septic shock)"
Hmisc::label(data$var_dose_why___3) = "Why? (choice=To achieve higher tissue concentration (e.g., CNS infection))"
Hmisc::label(data$v1_ab_empirical) = "Would you consider the coverage ofAcinetobacter baumannii in the empirical antibiotic therapy?"
Hmisc::label(data$v1_ab_urinary) = "If a urinary source of infection is confirmed, and urine cultures turn positive for A. baumannii (pending antibiogram results), would you change antibiotic therapy to....?"
Hmisc::label(data$a_b_comb_spec) = "Please specify"
Hmisc::label(data$a_b_mono_specify) = "Please specify"
Hmisc::label(data$vign_2_treatment) = "Would  you use cefiderocol in this scenario? "
Hmisc::label(data$v2_specify_combo) = "Please specify the combination drug you would use"
Hmisc::label(data$v2_specify_1stcoice) = "Please specify the first line treatment you would have used"
Hmisc::label(data$v3_1stlinetherapy___1) = "What would be your treatment of choice (select more than one treatment if you intend to use a combination therapy)?  (choice=Cefiderocol)"
Hmisc::label(data$v3_1stlinetherapy___2) = "What would be your treatment of choice (select more than one treatment if you intend to use a combination therapy)?  (choice=Aztreonam+ceftazidime/avibactam)"
Hmisc::label(data$v3_1stlinetherapy___3) = "What would be your treatment of choice (select more than one treatment if you intend to use a combination therapy)?  (choice=Colistin/polymyxin B)"
Hmisc::label(data$v3_1stlinetherapy___4) = "What would be your treatment of choice (select more than one treatment if you intend to use a combination therapy)?  (choice=Carbapenem)"
Hmisc::label(data$v3_1stlinetherapy___5) = "What would be your treatment of choice (select more than one treatment if you intend to use a combination therapy)?  (choice=Carbapenem high-dose extended-infusion)"
Hmisc::label(data$v3_1stlinetherapy___6) = "What would be your treatment of choice (select more than one treatment if you intend to use a combination therapy)?  (choice=Aminoglicoside)"
Hmisc::label(data$v3_1stlinetherapy___7) = "What would be your treatment of choice (select more than one treatment if you intend to use a combination therapy)?  (choice=Tigecycline)"
Hmisc::label(data$v3_1stlinetherapy___8) = "What would be your treatment of choice (select more than one treatment if you intend to use a combination therapy)?  (choice=Quinolone)"
Hmisc::label(data$v3_1stlinetherapy___9) = "What would be your treatment of choice (select more than one treatment if you intend to use a combination therapy)?  (choice=Trimethoprim-sulfamethoxazole)"
...
Hmisc::label(data$crabhap_target) = "Which therapy would you choose?"
Hmisc::label(data$cefi_crab_hap) = "Would you consider cefiderocol if the patient developed septic shock and the antibiogram for A. baumannii was still pending?"
Hmisc::label(data$otherd_combocefi___1) = "Please specify the other drug (s) (choice=Amikacin)"
Hmisc::label(data$otherd_combocefi___2) = "Please specify the other drug (s) (choice=Colistin/polymyxin B)"
Hmisc::label(data$otherd_combocefi___3) = "Please specify the other drug (s) (choice=Tigeciclin)"
Hmisc::label(data$otherd_combocefi___4) = "Please specify the other drug (s) (choice=Ampicillin/sulbactam)"
Hmisc::label(data$otherd_combocefi___5) = "Please specify the other drug (s) (choice=High dose meropenem)"
Hmisc::label(data$otherd_combocefi___6) = "Please specify the other drug (s) (choice=Other)"
Hmisc::label(data$spec_otherd_crabhap) = "Please specify other drug"
Hmisc::label(data$questionnaire_complete) = "Complete?"
# #Setting Units
