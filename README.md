...
│
├── Main_SR.qmd                         # Main manuscript (Quarto source)
├── Main_SR.docx                        # Compiled Word document
│
├── Supplementary_SR.qmd                # Supplementary material (Quarto source)
├── Supplementary_SR.docx               # Compiled supplementary Word document
│
...
It is possible to switch the output to an **Elsevier-formatted PDF** by: - **Commenting** out `csl: Utils/elsevier-vancouver.csl` and `format: docx` - **Uncommenting** the `format: elsevier-pdf` block in the Quarto YAML header
